...
<template>
    ...
    <footer class="absolute bottom-0 w-full text-center p-1 text-zinc-600 text-sm" :style="{opacity: isTransparent-0.5}">Copyright © 2024 TAiONS 丨 <a href="https://github.com/Yuuikic/LyricsPoster" target="_blank" class=" hover:text-indigo-500 transition-all">GitHub</a> </footer>
</template>
